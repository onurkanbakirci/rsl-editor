...
interface EditRslFormProps {
  rslId: string;
  initialUrl: string;
  initialProtocol: string;
  initialLinks: CrawledLink[];
}

export function EditRslForm({ rslId, initialUrl, initialProtocol, initialLinks }: EditRslFormProps) {
  const router = useRouter();
  const [url, setUrl] = useState(initialUrl);
  const [protocol, setProtocol] = useState<"http" | "https">(initialProtocol as "http" | "https");
  const [crawledLinks, setCrawledLinks] = useState<CrawledLink[]>(initialLinks);
  ...
  return (
    <>
      <DashboardHeader
        heading="Edit RSL"
        text="Update your RSL document configuration and licensing terms."
      >
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Update your RSL document with the current configuration
              </CardDescription>
            </CardHeader>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                        <p>
                          Please select at least one link to include in your RSL document.
                        </p>
                      </div>
                    </div>
                  </div>
