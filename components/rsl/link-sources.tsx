...
interface LinkSourcesProps {
  crawledLinks: CrawledLink[];
  isCrawling: boolean;
  searchTerm: string;
  sortBy: string;
  expandedUrls: Set<string>;
  activeLicenseTab: Record<string, string>;
  onSearchTermChange: (term: string) => void;
  onSortByChange: (sortBy: string) => void;
  onToggleSelectAll: () => void;
  onToggleLinkSelection: (linkUrl: string) => void;
  onToggleUrlExpanded: (url: string) => void;
  onUpdatePageFormData: (
    pageUrl: string,
    formData: Partial<CrawledLink["formData"]>
  ) => void;
  onAddLicense: (pageUrl: string) => void;
  onRemoveLicense: (pageUrl: string, licenseId: string) => void;
  onSetActiveLicenseTab: (tabs: Record<string, string>) => void;
  mode?: "create" | "edit";
}
        ...
        {isCrawling ? (
          <div className="py-12 text-center">
            ...
            <p className="text-lg font-medium">
              {mode === "edit" ? "Refetching links..." : "Crawling website..."}
            </p>
              ...
              {filteredLinks.map((link) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() => onToggleUrlExpanded(link.url)}
                  >
                    <div className="flex min-w-0 flex-1 items-center gap-3">
                      <Checkbox
                        checked={link.selected}
                        onCheckedChange={() => onToggleLinkSelection(link.url)}
                      ...
                      {link.selected ? (
                                          ...
                                          {licenses.map((license) => (
                                            <div key={license.id} className="flex items-center">
                                              ...
                                              <Button
                                                variant="ghost"
                                                size="sm"
                                                onClick={() => onRemoveLicense(link.url, license.id)}
                        ...
                        <div className="p-4 text-center text-muted-foreground">
                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              e.stopPropagation();
                              onToggleLinkSelection(link.url);
                            }}
                          >
                            Select URL
                          </Button>
