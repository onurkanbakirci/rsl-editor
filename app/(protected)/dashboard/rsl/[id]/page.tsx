                  ...
                  <TabsContent value="edit" className="space-y-4">
                    ...
                    <div className="rounded-lg bg-muted/50 p-4">
                      <div className="flex items-start gap-2">
                        <Icons.info className="size-4 mt-0.5 text-muted-foreground" />
                        <p className="text-sm text-muted-foreground">
                          Editing existing RSL configuration. Modify the settings below and click "Update RSL" to regenerate the document.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                        ...
                        >
                          <div className="flex items-center gap-3 flex-1 min-w-0">
                            ...
                            <div className="flex items-center gap-2 flex-1 min-w-0">
                              ...
                              <Badge variant="secondary" className="bg-blue-500/10 text-blue-700 border-blue-200 text-xs flex-shrink-0">
                                Existing
                              </Badge>
                            </div>
                          </div>
